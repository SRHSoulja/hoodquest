...
```solidity
// All canonical shared structs (HeistSnapshot, RewardBundle, etc.) are imported from HoodQuestTypes.sol
...
```solidity
// All canonical shared enums and structs (EventKind, ActionKind, EventConfig) are imported from HoodQuestTypes.sol
using HoodQuestTypes for *;
